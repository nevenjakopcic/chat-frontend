<template>
    <q-item active-class="bg-grey-4 text-blue-7">
        ...
        <q-item-section top side>
            <q-btn @click="cancelFriendRequest" flat dense round size="12px" color="negative" icon="close" />
        </q-item-section>
    </q-item>
</template>
...
async function cancelFriendRequest() {
    await RelationshipService.cancelFriendRequest(props.relationship.otherUser.id);
    updateRelationship();
}
